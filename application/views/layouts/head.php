...
<!-- Website Icons -->
<link rel="apple-touch-icon" sizes="76x76" href="<?=base_url('assets/img/icons/IconoCuino.png');?>">
<link rel="icon" type="image/png" href="<?=base_url('assets/img/icons/IconoCuino.png');?>">
