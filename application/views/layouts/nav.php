                ...
                <?php } else {?>
                    <a href="<?=site_url('Login');?>">
                        <button class="boton-salir boton-salir-600" <?php if(!isset($this->session->id))?>>
                            <ion-icon name="log-in-outline" class="icon-boton-log-out-media-Plus-that-1024xp icon-boton-log-out-media-Plus-that-1024xp icon-boton-log-out-media-Plus-that-769px" id="icono-log-in"></ion-icon>
